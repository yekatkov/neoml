...
//	}
//private:
//	static void printInfo( std::stringstream& ss, const std::list<CInfo>& info, const char* head, const char* tag )
//	{
//		ss << std::endl << tag << ";" << head << std::endl;
//		for( auto& i : info ) {
//			ss << tag << ";";
//			for( auto& t : i.Timers ) {
//				ss << t.GetTimeInMs() << ";";
...
//	static void printCountedInfo( std::stringstream& ss, const std::multimap<std::list<int>, CInfo>& countedinfo,
